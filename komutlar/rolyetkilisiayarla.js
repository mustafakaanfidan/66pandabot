  ...
  let komutum = client.cmdd
        if(komutum[message.guild.id]) {
            for (var i = 0; i < Object.keys(komutum[message.guild.id]).length; i++) {
              if (!args[0]) return message.channel.send(`Rol Yetkilisi Rolünü Ayarlamak İçin, Belirlenen Rolü Etiketlemelisiniz
...
Eğer Etiketlenmiyorsa Rol Ayarlarından \`O Role Herkese Bu Rolden Bahsetme Yetkisi Tanı Vermelisiniz.\``)
              if(args[0] === Object.keys(komutum[message.guild.id][i])[0]) {
                    ...
                    if (!rol) {
                      return message.channel.send(` Rol Yetkilisi Rolünü Ayarlamak İçin, Belirlenen Rolü Etiketlemelisiniz
...
Eğer Etiketlenmiyorsa Rol Ayarlarından \`O Role Herkese Bu Rolden Bahsetme Yetkisi Tanı Vermelisiniz.\``)
                    ...
                    .setColor("GREEN")
                    .addField(` Verildi`, rol)
                    return message.channel.send(embed)
                } else {
                 return message.channel.send(`Rol Yetkilisi Rolünü Ayarlamak İçin, Bir Komut İsmi Girmelisin
Örnek: \`!rol-yetkilisi-ayarla komutismi @rol\`
