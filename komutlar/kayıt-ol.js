...
exports.run = function(client, message, args) {
 ...
 let yas = args[1]
  ...
  if(!isim) return message.channel.sendMessage('Seni Kayıt Etmem İçin Bir İsim Girmelisin: `!kayıt Muhammed `');
  if(!yas) return message.channel.sendMessage('Seni Kayıt Etmem İçin Bir Yaş Girmelisin: `!kayıt Muhammed 16`');
