...
exports.run = async (bot, message, args) =>
{
  ...
  if (message.guild.member(message.author.id).hasPermission(0x8))
    
    {
      ...
      if (!mentionedRole) return message.channel.sendMessage("Kayıt Rolu Ayarlamak Için Rol Etiketlemelisin. `t!kayıt-alınacak-rol-ayarla @rol`".then(msg => msg.delete(5000)));
