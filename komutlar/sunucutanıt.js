...
exports.run = async (client, message, args) => {
  ...
  .setTitle('PANDA', client.user.avatarURL)
  .setURL("https://discord.gg/JBFApa5")
  .setDescription("!sunucutanıt Kullandınız.")
  .addField('Sizin Sunucunuz Burada Tanıtıldı', `[Tıkla](https://discord.gg/JBFApa5)`)
        .setTimestamp()
 ...
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('722386697656205422').send(embed)
            });
